...
const data = {
  '브이로그': [
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #1' },
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #2' },
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #3' },
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #3' },
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #3' },
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #3' },
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #3' },
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #3' },
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #3' },
    { image: 'https://via.placeholder.com/150', description: '감성 돋는 아날로그 로우파이 음악 #4' },
    // ...additional items
  ],
  '귀여운 음악': [
    { image: 'https://via.placeholder.com/150', description: '귀여운 음악 #1' },
    { image: 'https://via.placeholder.com/150', description: '귀여운 음악 #2' },
    { image: 'https://via.placeholder.com/150', description: '귀여운 음악 #3' },
    { image: 'https://via.placeholder.com/150', description: '귀여운 음악 #4' },
    // ...additional items
  ],
  // Add more categories with at least 6 data items each
};
...
const selectedData = computed(() => {
  return data[selectedCategory.value] || [];
});
...
const prevSlide = () => {
  if 
  (buttonSwiper.value && buttonSwiper.value.swiper) {
