...
const fetchCuration = async () => {
  ...
  try {
    ...
    errorMessage.value = "Failed to fetch curation data. Please try again later.";
...
.song-curation-album-item > ul {
  display: flex;
  flex-wrap: wrap;
  justify-content: center;
}
.song-curation-album-item > ul > .album-content {
  list-style: none;
  margin: 20px;
  cursor: pointer;
}
.song-curation-album-item > ul > .album-content > img {
  width: 264px;
  height: 264px;
  object-fit: cover;
}
